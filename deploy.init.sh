...
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/http-gateway/ns/_/http-gateway.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/http-gateway/ns/_/http-gateway-headless.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/http-gateway/ns/_/http-gateway-service.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/http-gateway/ns/${NAMESPACE}/http-gateway-config.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/http-gateway/ns/${NAMESPACE}/http-gateway-environment.yaml"
FILE_FROM_GITHUB "deploy/k8s" "${SOURCE}/apps/http-gateway/ns/${NAMESPACE}/http-gateway-ingress.yaml"
